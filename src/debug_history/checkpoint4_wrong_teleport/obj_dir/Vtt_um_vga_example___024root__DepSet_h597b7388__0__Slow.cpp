...
VL_ATTR_COLD void Vtt_um_vga_example___024root___ctor_var_reset(Vtt_um_vga_example___024root* vlSelf) {
    ...
    vlSelf->tt_um_vga_example__DOT__game_started = VL_RAND_RESET_I(1);
    ...
    vlSelf->tt_um_vga_example__DOT__spawn_ball = VL_RAND_RESET_I(1);
    ...
    vlSelf->tt_um_vga_example__DOT__spawn_req_meta = VL_RAND_RESET_I(1);
    vlSelf->tt_um_vga_example__DOT__spawn_req_sync = VL_RAND_RESET_I(1);
    vlSelf->tt_um_vga_example__DOT__spawn_ack = VL_RAND_RESET_I(1);
    vlSelf->tt_um_vga_example__DOT__pending_y = VL_RAND_RESET_I(10);
    vlSelf->tt_um_vga_example__DOT__pending_phys = VL_RAND_RESET_I(8);
    ...
    vlSelf->tt_um_vga_example__DOT__comms__DOT__state = VL_RAND_RESET_I(2);
    ...
    vlSelf->tt_um_vga_example__DOT__comms__DOT__rx_shift_cnt = VL_RAND_RESET_I(2);
    vlSelf->tt_um_vga_example__DOT__comms__DOT__rx_shift_reg = VL_RAND_RESET_I(16);
    ...
    vlSelf->__Vdly__tt_um_vga_example__DOT__spawn_req_meta = VL_RAND_RESET_I(1);
    vlSelf->__Vdly__tt_um_vga_example__DOT__comms__DOT__rx_shift_cnt = VL_RAND_RESET_I(2);
    vlSelf->__Vdly__tt_um_vga_example__DOT__comms__DOT__rx_shift_reg = VL_RAND_RESET_I(16);
    vlSelf->__Vdly__tt_um_vga_example__DOT__spawn_ack = VL_RAND_RESET_I(1);
