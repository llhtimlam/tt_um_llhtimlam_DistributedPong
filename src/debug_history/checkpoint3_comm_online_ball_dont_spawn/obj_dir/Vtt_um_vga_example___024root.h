...
class alignas(VL_CACHE_LINE_BYTES) Vtt_um_vga_example___024root final : public VerilatedModule {
  public:
    ...
    CData/*7:0*/ tt_um_vga_example__DOT__ball_phys;
    CData/*0:0*/ tt_um_vga_example__DOT__comm_sync_out;
    CData/*0:0*/ tt_um_vga_example__DOT__spawn_ready;
    ...
    CData/*0:0*/ tt_um_vga_example__DOT__spawn_acked;
    ...
    CData/*7:0*/ tt_um_vga_example__DOT__comms__DOT__rx_byte1;
    CData/*7:0*/ tt_um_vga_example__DOT__comms__DOT__rx_byte2;
    CData/*0:0*/ __Vdly__tt_um_vga_example__DOT__nego_done_reg;
    CData/*1:0*/ __Vdly__tt_um_vga_example__DOT__comms__DOT__rx_state;
    CData/*7:0*/ __Vdly__tt_um_vga_example__DOT__comms__DOT__rx_byte1;
    CData/*7:0*/ __Vdly__tt_um_vga_example__DOT__comms__DOT__rx_byte2;
    CData/*0:0*/ __Vdly__tt_um_vga_example__DOT__spawn_acked;
    ...
    SData/*9:0*/ tt_um_vga_example__DOT__received_y;
