...
VL_INLINE_OPT void Vtt_um_vga_example___024root___nba_sequent__TOP__0(Vtt_um_vga_example___024root* vlSelf) {
    ...
    vlSelfRef.__Vdly__tt_um_vga_example__DOT__comms__DOT__rx_byte1 
        = vlSelfRef.tt_um_vga_example__DOT__comms__DOT__rx_byte1;
    vlSelfRef.__Vdly__tt_um_vga_example__DOT__comms__DOT__rx_byte2 
        = vlSelfRef.tt_um_vga_example__DOT__comms__DOT__rx_byte2;
    ...
    if (vlSelfRef.tt_um_vga_example__DOT____Vcellinp__comms__reset) {
        ...
        if ((0U == (IData)(vlSelfRef.tt_um_vga_example__DOT__comms__DOT__state))) {
            ...
            vlSelfRef.uio_out = ((0xc0U & ((IData)(vlSelfRef.tt_um_vga_example__DOT__ball_y) 
                                           >> 2U)) 
                                 | ((0x38U & ((IData)(vlSelfRef.tt_um_vga_example__DOT__ball_phys) 
                                              >> 2U)) 
                                    | (7U & ((IData)(vlSelfRef.tt_um_vga_example__DOT__ball_phys) 
                                             >> 1U))));
           ...
           ((IData)(vlSelfRef.tt_um_vga_example__DOT__nego_done_reg) 
            && ((IData)(vlSelfRef.tt_um_vga_example__DOT__has_ball) 
                && ((IData)(vlSelfRef.tt_um_vga_example__DOT__is_right_fpga_reg)
                     ? ((0x14aU >= (IData)(vlSelfRef.tt_um_vga_example__DOT__ball_x)) 
                        & (0x136U <= (IData)(vlSelfRef.tt_um_vga_example__DOT__ball_x)))
                     : ((0x136U <= (IData)(vlSelfRef.tt_um_vga_example__DOT__ball_x)) 
                        & (0x14aU >= (IData)(vlSelfRef.tt_um_vga_example__DOT__ball_x)))))));
}
...
VL_INLINE_OPT void Vtt_um_vga_example___024root___nba_sequent__TOP__1(Vtt_um_vga_example___024root* vlSelf) {
    ...
    vlSelfRef.__Vdly__tt_um_vga_example__DOT__spawn_acked 
        = vlSelfRef.tt_um_vga_example__DOT__spawn_acked;
    ...
    if (vlSelfRef.sim_rst) {
        ...
        vlSelfRef.__Vdly__tt_um_vga_example__DOT__spawn_acked = 0U;
    } else if (vlSelfRef.tt_um_vga_example__DOT__nego_done_reg) {
        if (((IData)(vlSelfRef.tt_um_vga_example__DOT__spawn_ready) 
             & (~ (IData)(vlSelfRef.tt_um_vga_example__DOT__has_ball)))) {
            vlSelfRef.__Vdly__tt_um_vga_example__DOT__spawn_acked = 1U;
            __Vdly__tt_um_vga_example__DOT__has_ball = 1U;
            __Vdly__tt_um_vga_example__DOT__ball_y 
                = vlSelfRef.tt_um_vga_example__DOT__received_y;
            __Vdly__tt_um_vga_example__DOT__vel_x = 
                (0xfU & ((IData)(vlSelfRef.tt_um_vga_example__DOT__rx_phys) 
                         >> 4U));
    ...
    vlSelfRef.tt_um_vga_example__DOT__ball_phys = (
                                                   ((IData)(vlSelfRef.tt_um_vga_example__DOT__vel_x) 
                                                    << 4U) 
                                                   | (IData)(vlSelfRef.tt_um_vga_example__DOT__vel_y));
}
...
VL_INLINE_OPT void Vtt_um_vga_example___024root___nba_sequent__TOP__2(Vtt_um_vga_example___024root* vlSelf) {
    ...
    if (vlSelfRef.tt_um_vga_example__DOT____Vcellinp__comms__reset) {
        ...
        vlSelfRef.tt_um_vga_example__DOT__spawn_ready = 0U;
        vlSelfRef.tt_um_vga_example__DOT__received_y = 0U;
        vlSelfRef.tt_um_vga_example__DOT__rx_phys = 0U;
        vlSelfRef.__Vdly__tt_um_vga_example__DOT__comms__DOT__rx_byte1 = 0U;
        vlSelfRef.__Vdly__tt_um_vga_example__DOT__comms__DOT__rx_byte2 = 0U;
    } else {
        if (vlSelfRef.tt_um_vga_example__DOT__spawn_acked) {
            vlSelfRef.tt_um_vga_example__DOT__spawn_ready = 0U;
        }
        ...
        if ((8U & (IData)(vlSelfRef.ui_in))) {
            if ((0U == (IData)(vlSelfRef.tt_um_vga_example__DOT__comms__DOT__rx_state))) {
                ...
                vlSelfRef.tt_um_vga_example__DOT__received_y 
                    = ((0x300U & ((IData)(vlSelfRef.tt_um_vga_example__DOT__comms__DOT__rx_byte2) 
                                  << 2U)) | (IData)(vlSelfRef.tt_um_vga_example__DOT__comms__DOT__rx_byte1));
                vlSelfRef.tt_um_vga_example__DOT__spawn_ready = 1U;
                vlSelfRef.tt_um_vga_example__DOT__rx_phys 
                    = ((0xe0U & ((IData)(vlSelfRef.tt_um_vga_example__DOT__comms__DOT__rx_byte2) 
                                 << 2U)) | (0xeU & 
                                            ((IData)(vlSelfRef.tt_um_vga_example__DOT__comms__DOT__rx_byte2) 
                                             << 1U)));
                vlSelfRef.__Vdly__tt_um_vga_example__DOT__comms__DOT__rx_byte2 
                    = vlSelfRef.uio_in;
            }
...
VL_INLINE_OPT void Vtt_um_vga_example___024root___nba_sequent__TOP__3(Vtt_um_vga_example___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.tt_um_vga_example__DOT__spawn_acked = vlSelfRef.__Vdly__tt_um_vga_example__DOT__spawn_acked;
}
