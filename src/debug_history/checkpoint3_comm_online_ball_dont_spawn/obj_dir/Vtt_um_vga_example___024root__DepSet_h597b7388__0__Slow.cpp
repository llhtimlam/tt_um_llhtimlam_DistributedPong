...
VL_ATTR_COLD void Vtt_um_vga_example___024root___ctor_var_reset(Vtt_um_vga_example___024root* vlSelf) {
    ...
    vlSelf->tt_um_vga_example__DOT__ball_phys = VL_RAND_RESET_I(8);
    vlSelf->tt_um_vga_example__DOT__comm_sync_out = VL_RAND_RESET_I(1);
    vlSelf->tt_um_vga_example__DOT__spawn_ready = VL_RAND_RESET_I(1);
    vlSelf->tt_um_vga_example__DOT__received_y = VL_RAND_RESET_I(10);
    ...
    vlSelf->tt_um_vga_example__DOT__spawn_acked = VL_RAND_RESET_I(1);
    ...
    vlSelf->tt_um_vga_example__DOT__comms__DOT__rx_state = VL_RAND_RESET_I(2);
    vlSelf->tt_um_vga_example__DOT__comms__DOT__rx_byte1 = VL_RAND_RESET_I(8);
    vlSelf->tt_um_vga_example__DOT__comms__DOT__rx_byte2 = VL_RAND_RESET_I(8);
    ...
    vlSelf->__Vdly__tt_um_vga_example__DOT__comms__DOT__rx_state = VL_RAND_RESET_I(2);
    vlSelf->__Vdly__tt_um_vga_example__DOT__comms__DOT__rx_byte1 = VL_RAND_RESET_I(8);
    vlSelf->__Vdly__tt_um_vga_example__DOT__comms__DOT__rx_byte2 = VL_RAND_RESET_I(8);
    vlSelf->__Vdly__tt_um_vga_example__DOT__spawn_acked = VL_RAND_RESET_I(1);
