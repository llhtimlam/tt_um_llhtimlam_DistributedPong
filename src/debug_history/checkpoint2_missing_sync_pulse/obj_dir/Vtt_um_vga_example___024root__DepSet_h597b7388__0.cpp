...
VL_INLINE_OPT void Vtt_um_vga_example___024root___nba_sequent__TOP__0(Vtt_um_vga_example___024root* vlSelf) {
    ...
    CData/*2:0*/ __Vdly__tt_um_vga_example__DOT__comms__DOT__state;
    ...
    if (vlSelfRef.tt_um_vga_example__DOT____Vcellinp__comms__reset) {
        ...
        vlSelfRef.tt_um_vga_example__DOT__comm_bus_out = 0U;
    } else {
        ...
        if ((0U == (IData)(vlSelfRef.tt_um_vga_example__DOT__comms__DOT__state))) {
            if (((IData)(vlSelfRef.tt_um_vga_example__DOT__comms__DOT__edge_detected) 
                 & (IData)(vlSelfRef.tt_um_vga_example__DOT__link_alive))) {
            ...
            vlSelfRef.tt_um_vga_example__DOT__comm_sync_out = 0U;
            __Vdly__tt_um_vga_example__DOT__comms__DOT__state = 4U;
        } else if ((4U == (IData)(vlSelfRef.tt_um_vga_example__DOT__comms__DOT__state))) {
            vlSelfRef.tt_um_vga_example__DOT__comm_bus_oe = 0U;
            __Vdly__tt_um_vga_example__DOT__comms__DOT__edge_detected = 0U;
            __Vdly__tt_um_vga_example__DOT__comms__DOT__state = 0U;
        } else {
           ...
           ((IData)(vlSelfRef.tt_um_vga_example__DOT__nego_done_reg) 
            && ((IData)(vlSelfRef.tt_um_vga_example__DOT__has_ball) 
                && ((IData)(vlSelfRef.tt_um_vga_example__DOT__is_right_fpga_reg)
                     ? ((0x140U >= (IData)(vlSelfRef.tt_um_vga_example__DOT__ball_x)) 
...
VL_INLINE_OPT void Vtt_um_vga_example___024root___nba_sequent__TOP__1(Vtt_um_vga_example___024root* vlSelf) {
    ...
    if (vlSelfRef.sim_rst) {
        ...
        if ((1U & (((~ (IData)(vlSelfRef.tt_um_vga_example__DOT__has_ball)) 
                    & (~ (IData)(vlSelfRef.tt_um_vga_example__DOT__spawn_trigger))) 
                   & (~ (IData)(vlSelfRef.tt_um_vga_example__DOT__is_right_fpga_reg))))) {
            ...
            __Vdly__tt_um_vga_example__DOT__vel_y = 
                ((8U & ((IData)(vlSelfRef.tt_um_vga_example__DOT__rx_phys) 
                        << 1U)) | (7U & (IData)(vlSelfRef.tt_um_vga_example__DOT__rx_phys)));
        }
    } else {
        __Vdly__tt_um_vga_example__DOT__has_ball = 0U;
    }
...
VL_INLINE_OPT void Vtt_um_vga_example___024root___nba_sequent__TOP__2(Vtt_um_vga_example___024root* vlSelf) {
    ...
    if (vlSelfRef.tt_um_vga_example__DOT____Vcellinp__comms__reset) {
        ...
        vlSelfRef.tt_um_vga_example__DOT__link_alive = 0U;
    } else {
        vlSelfRef.tt_um_vga_example__DOT__spawn_trigger = 0U;
        if ((1U & (((IData)(vlSelfRef.ui_in) >> 3U) 
            ...
            vlSelfRef.tt_um_vga_example__DOT__rx_y 
                = vlSelfRef.uio_in;
            vlSelfRef.__Vdly__tt_um_vga_example__DOT__comms__DOT__watchdog = 0U;
            vlSelfRef.tt_um_vga_example__DOT__link_alive = 1U;
        } else if ((0xc350U > (IData)(vlSelfRef.tt_um_vga_example__DOT__comms__DOT__watchdog))) {
            vlSelfRef.__Vdly__tt_um_vga_example__DOT__comms__DOT__watchdog 
