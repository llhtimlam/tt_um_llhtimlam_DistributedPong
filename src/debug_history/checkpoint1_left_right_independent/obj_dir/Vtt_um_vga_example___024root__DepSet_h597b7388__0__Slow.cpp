...
VL_ATTR_COLD void Vtt_um_vga_example___024root___ctor_var_reset(Vtt_um_vga_example___024root* vlSelf) {
    ...
    vlSelf->tt_um_vga_example__DOT__is_right_fpga = VL_RAND_RESET_I(1);
    vlSelf->tt_um_vga_example__DOT__nego_done = VL_RAND_RESET_I(1);
    ...
    vlSelf->tt_um_vga_example__DOT__comms__DOT__tx_state = VL_RAND_RESET_I(2);
    ...
    vlSelf->tt_um_vga_example__DOT__comms__DOT__startup_delay = VL_RAND_RESET_I(4);
    vlSelf->__Vdly__tt_um_vga_example__DOT__nego_done = VL_RAND_RESET_I(1);
