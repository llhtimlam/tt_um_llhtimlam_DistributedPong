...
VL_INLINE_OPT void Vtt_um_vga_example___024root___ico_sequent__TOP__0(Vtt_um_vga_example___024root* vlSelf) {
    ...
    vlSelfRef.tt_um_vga_example__DOT____Vcellinp__comms__reset 
        = (1U & ((~ (IData)(vlSelfRef.tt_um_vga_example__DOT__nego_done)) 
...
VL_INLINE_OPT void Vtt_um_vga_example___024root___nba_sequent__TOP__0(Vtt_um_vga_example___024root* vlSelf) {
    ...
    CData/*3:0*/ __Vdly__tt_um_vga_example__DOT__comms__DOT__startup_delay;
    __Vdly__tt_um_vga_example__DOT__comms__DOT__startup_delay = 0;
    CData/*1:0*/ __Vdly__tt_um_vga_example__DOT__comms__DOT__tx_state;
    __Vdly__tt_um_vga_example__DOT__comms__DOT__tx_state = 0;
    // Body
    __Vdly__tt_um_vga_example__DOT__comms__DOT__startup_delay 
        = vlSelfRef.tt_um_vga_example__DOT__comms__DOT__startup_delay;
    vlSelfRef.__Vdly__tt_um_vga_example__DOT__comms__DOT__rx_state 
        = vlSelfRef.tt_um_vga_example__DOT__comms__DOT__rx_state;
    vlSelfRef.__Vdly__tt_um_vga_example__DOT__comms__DOT__watchdog 
        = vlSelfRef.tt_um_vga_example__DOT__comms__DOT__watchdog;
    vlSelfRef.__Vdly__tt_um_vga_example__DOT__nego_timer 
        = vlSelfRef.tt_um_vga_example__DOT__nego_timer;
    vlSelfRef.__Vdly__tt_um_vga_example__DOT__nego_done 
        = vlSelfRef.tt_um_vga_example__DOT__nego_done;
    __Vdly__tt_um_vga_example__DOT__comms__DOT__tx_state 
        = vlSelfRef.tt_um_vga_example__DOT__comms__DOT__tx_state;
    ...
    if (vlSelfRef.tt_um_vga_example__DOT____Vcellinp__comms__reset) {
        __Vdly__tt_um_vga_example__DOT__comms__DOT__startup_delay = 0U;
        vlSelfRef.__Vdly__tt_um_vga_example__DOT__comms__DOT__watchdog = 0xffffU;
        __Vdly__tt_um_vga_example__DOT__comms__DOT__tx_state = 0U;
        vlSelfRef.tt_um_vga_example__DOT__comm_sync_out = 0U;
        vlSelfRef.tt_um_vga_example__DOT__comm_bus_oe = 0U;
    } else {
        if (((IData)(vlSelfRef.tt_um_vga_example__DOT__vsync) 
             & (0xfU > (IData)(vlSelfRef.tt_um_vga_example__DOT__comms__DOT__startup_delay)))) {
            __Vdly__tt_um_vga_example__DOT__comms__DOT__startup_delay 
                = (0xfU & ((IData)(1U) + (IData)(vlSelfRef.tt_um_vga_example__DOT__comms__DOT__startup_delay)));
        }
        if ((1U & (((IData)(vlSelfRef.ui_in) >> 3U) 
                   & (~ (IData)(vlSelfRef.tt_um_vga_example__DOT__comms__DOT__in_sync_prev))))) {
            vlSelfRef.__Vdly__tt_um_vga_example__DOT__comms__DOT__watchdog = 0U;
        } else if ((0xffffU > (IData)(vlSelfRef.tt_um_vga_example__DOT__comms__DOT__watchdog))) {
            vlSelfRef.__Vdly__tt_um_vga_example__DOT__comms__DOT__watchdog 
                = (0xffffU & ((IData)(1U) + (IData)(vlSelfRef.tt_um_vga_example__DOT__comms__DOT__watchdog)));
        }
        if ((0U == (IData)(vlSelfRef.tt_um_vga_example__DOT__comms__DOT__tx_state))) {
            if ((((IData)(vlSelfRef.tt_um_vga_example__DOT__ball_at_edge_reg) 
                  & (0xa000U > (IData)(vlSelfRef.tt_um_vga_example__DOT__comms__DOT__watchdog))) 
                 & (0xfU == (IData)(vlSelfRef.tt_um_vga_example__DOT__comms__DOT__startup_delay)))) {
                vlSelfRef.tt_um_vga_example__DOT__comm_sync_out = 1U;
                vlSelfRef.tt_um_vga_example__DOT__comm_bus_oe = 0xffU;
                vlSelfRef.tt_um_vga_example__DOT__comm_bus_out 
                    = (0xffU & (IData)(vlSelfRef.tt_um_vga_example__DOT__ball_y));
                __Vdly__tt_um_vga_example__DOT__comms__DOT__tx_state = 1U;
            }
        } else if ((1U == (IData)(vlSelfRef.tt_um_vga_example__DOT__comms__DOT__tx_state))) {
            vlSelfRef.tt_um_vga_example__DOT__comm_bus_out 
                = ((0xc0U & ((IData)(vlSelfRef.tt_um_vga_example__DOT__ball_y) 
                             >> 2U)) | ((0x38U & ((IData)(vlSelfRef.tt_um_vga_example__DOT____Vcellinp__comms__ball_phys) 
                                                  >> 1U)) 
                                        | (7U & (IData)(vlSelfRef.tt_um_vga_example__DOT____Vcellinp__comms__ball_phys))));
            __Vdly__tt_um_vga_example__DOT__comms__DOT__tx_state = 2U;
        } else if ((2U == (IData)(vlSelfRef.tt_um_vga_example__DOT__comms__DOT__tx_state))) {
            vlSelfRef.tt_um_vga_example__DOT__comm_sync_out = 0U;
            vlSelfRef.tt_um_vga_example__DOT__comm_bus_oe = 0U;
            __Vdly__tt_um_vga_example__DOT__comms__DOT__tx_state = 3U;
        } else if ((3U == (IData)(vlSelfRef.tt_um_vga_example__DOT__comms__DOT__tx_state))) {
            if ((1U & (~ (IData)(vlSelfRef.tt_um_vga_example__DOT__ball_at_edge_reg)))) {
                __Vdly__tt_um_vga_example__DOT__comms__DOT__tx_state = 0U;
            }
        } else {
            __Vdly__tt_um_vga_example__DOT__comms__DOT__tx_state = 0U;
    ...
    if (((IData)(vlSelfRef.sim_rst) | (IData)(vlSelfRef.tt_um_vga_example__DOT__spawn_trigger))) {
    ...
    vlSelfRef.tt_um_vga_example__DOT__ball_at_edge_reg 
        = ((~ (IData)(vlSelfRef.sim_rst)) & ((IData)(vlSelfRef.tt_um_vga_example__DOT__is_right_fpga)
                                              ? (5U 
...
VL_INLINE_OPT void Vtt_um_vga_example___024root___nba_sequent__TOP__1(Vtt_um_vga_example___024root* vlSelf) {
    ...
    if ((1U & ((IData)(vlSelfRef.sim_rst) | (~ (IData)(vlSelfRef.tt_um_vga_example__DOT__nego_done))))) {
        __Vdly__tt_um_vga_example__DOT__has_ball = 
            (1U & (~ (IData)(vlSelfRef.tt_um_vga_example__DOT__is_right_fpga)));
        if (vlSelfRef.tt_um_vga_example__DOT__is_right_fpga) {
            __Vdly__tt_um_vga_example__DOT__ball_x = 0x14aU;
            __Vdly__tt_um_vga_example__DOT__vel_x = 4U;
        } else {
            __Vdly__tt_um_vga_example__DOT__ball_x = 0x136U;
            __Vdly__tt_um_vga_example__DOT__vel_x = 0xcU;
        }
    ...
    } else if (vlSelfRef.tt_um_vga_example__DOT__has_ball) {
                                                  ...
                                                  & ((IData)(vlSelfRef.tt_um_vga_example__DOT__ball_x) 
                                                     ...
                                                     ((0x3f0U 
                                                       & ((- (IData)(
                                                          ...
                                                          << 4U)) 
                                                      | (IData)(vlSelfRef.tt_um_vga_example__DOT__vel_x))));
        __Vdly__tt_um_vga_example__DOT__ball_y = (0x3ffU 
        ...
        if (vlSelfRef.tt_um_vga_example__DOT__is_right_fpga) {
            ...
            if ((0x145U >= (IData)(vlSelfRef.tt_um_vga_example__DOT__ball_x))) {
                if ((0xa000U > (IData)(vlSelfRef.tt_um_vga_example__DOT__comms__DOT__watchdog))) {
                    __Vdly__tt_um_vga_example__DOT__has_ball = 0U;
                } else {
                    __Vdly__tt_um_vga_example__DOT__vel_x = 4U;
                    __Vdly__tt_um_vga_example__DOT__ball_x = 0x146U;
                }
            }
        } else {
            ...
            if ((0x13bU <= (IData)(vlSelfRef.tt_um_vga_example__DOT__ball_x))) {
                if ((0xa000U > (IData)(vlSelfRef.tt_um_vga_example__DOT__comms__DOT__watchdog))) {
                    ...
                    __Vdly__tt_um_vga_example__DOT__vel_x = 0xcU;
                    __Vdly__tt_um_vga_example__DOT__ball_x = 0x13aU;
                }
            }
        }
    } else if (vlSelfRef.tt_um_vga_example__DOT__spawn_trigger) {
        if (vlSelfRef.tt_um_vga_example__DOT__is_right_fpga) {
            __Vdly__tt_um_vga_example__DOT__vel_x = 4U;
            __Vdly__tt_um_vga_example__DOT__ball_x = 0x14aU;
        } else {
        ...
        __Vdly__tt_um_vga_example__DOT__ball_y = ((0x300U 
                                                   & ((IData)(vlSelfRef.tt_um_vga_example__DOT__rx_phys) 
                                                      << 2U)) 
                                                  | (IData)(vlSelfRef.tt_um_vga_example__DOT__rx_y));
        __Vdly__tt_um_vga_example__DOT__vel_y = ((8U 
                                                  & ((IData)(vlSelfRef.tt_um_vga_example__DOT__rx_phys) 
                                                     << 1U)) 
                                                 | (7U 
                                                    & (IData)(vlSelfRef.tt_um_vga_example__DOT__rx_phys)));
    ...
    if ((((IData)(vlSelfRef.ui_in) >> 1U) & (0x1a0U 
                                             > (IData)(vlSelfRef.tt_um_vga_example__DOT__paddle_y)))) {
        __Vdly__tt_um_vga_example__DOT__paddle_y = 
            (0x1ffU & ((IData)(5U) + (IData)(vlSelfRef.tt_um_vga_example__DOT__paddle_y)));
    }
...
VL_INLINE_OPT void Vtt_um_vga_example___024root___nba_sequent__TOP__2(Vtt_um_vga_example___024root* vlSelf) {
    ...
    vlSelfRef.tt_um_vga_example__DOT__comms__DOT__watchdog 
        = vlSelfRef.__Vdly__tt_um_vga_example__DOT__comms__DOT__watchdog;
    if (vlSelfRef.tt_um_vga_example__DOT____Vcellinp__comms__reset) {
        vlSelfRef.__Vdly__tt_um_vga_example__DOT__comms__DOT__rx_state = 0U;
        vlSelfRef.tt_um_vga_example__DOT__spawn_trigger = 0U;
    } else if ((8U & (IData)(vlSelfRef.ui_in))) {
        if ((0U == (IData)(vlSelfRef.tt_um_vga_example__DOT__comms__DOT__rx_state))) {
            vlSelfRef.tt_um_vga_example__DOT__rx_y 
                = vlSelfRef.uio_in;
            vlSelfRef.__Vdly__tt_um_vga_example__DOT__comms__DOT__rx_state = 1U;
        } else if ((1U == (IData)(vlSelfRef.tt_um_vga_example__DOT__comms__DOT__rx_state))) {
            vlSelfRef.tt_um_vga_example__DOT__rx_phys 
                = vlSelfRef.uio_in;
            vlSelfRef.tt_um_vga_example__DOT__spawn_trigger = 1U;
            vlSelfRef.__Vdly__tt_um_vga_example__DOT__comms__DOT__rx_state = 2U;
        } else if ((2U == (IData)(vlSelfRef.tt_um_vga_example__DOT__comms__DOT__rx_state))) {
            vlSelfRef.tt_um_vga_example__DOT__spawn_trigger = 0U;
        } else {
            vlSelfRef.__Vdly__tt_um_vga_example__DOT__comms__DOT__rx_state = 0U;
        }
    ...
    if (vlSelfRef.sim_rst) {
        vlSelfRef.tt_um_vga_example__DOT__is_right_fpga = 0U;
        vlSelfRef.__Vdly__tt_um_vga_example__DOT__nego_done = 0U;
        vlSelfRef.__Vdly__tt_um_vga_example__DOT__nego_timer = 0U;
    } else if ((1U & (~ (IData)(vlSelfRef.tt_um_vga_example__DOT__nego_done)))) {
        if ((0x80U & (IData)(vlSelfRef.ui_in))) {
            vlSelfRef.tt_um_vga_example__DOT__is_right_fpga = 1U;
            vlSelfRef.__Vdly__tt_um_vga_example__DOT__nego_done = 1U;
        } else if ((1U & (IData)(vlSelfRef.uio_in))) {
            vlSelfRef.tt_um_vga_example__DOT__is_right_fpga = 1U;
            vlSelfRef.__Vdly__tt_um_vga_example__DOT__nego_done = 1U;
    ...
    vlSelfRef.tt_um_vga_example__DOT__nego_done = vlSelfRef.__Vdly__tt_um_vga_example__DOT__nego_done;
    vlSelfRef.uio_out = ((IData)(vlSelfRef.tt_um_vga_example__DOT__nego_done)
                          ? (IData)(vlSelfRef.tt_um_vga_example__DOT__comm_bus_out)
                          : 1U);
    vlSelfRef.tt_um_vga_example__DOT____Vcellinp__comms__reset 
        = (1U & ((~ (IData)(vlSelfRef.tt_um_vga_example__DOT__nego_done)) 
                 | (IData)(vlSelfRef.sim_rst)));
    vlSelfRef.uio_oe = (((~ (IData)(vlSelfRef.tt_um_vga_example__DOT__nego_done)) 
                         & ((~ (IData)(vlSelfRef.tt_um_vga_example__DOT__is_right_fpga)) 
                            & (0x1f000U < vlSelfRef.tt_um_vga_example__DOT__nego_timer)))
                         ? 0xffU : (IData)(vlSelfRef.tt_um_vga_example__DOT__comm_bus_oe));
}
